...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.ID = field.NewField(tableName, "id")
...
type IRoleDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Role, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (r roleDo) FilterWithNameAndRole(name string, role string) (result []model.Role, err error) {
