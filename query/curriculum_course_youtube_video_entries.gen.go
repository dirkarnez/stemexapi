...
type ICurriculumCourseYoutubeVideoEntriesDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.CurriculumCourseYoutubeVideoEntries, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (c curriculumCourseYoutubeVideoEntriesDo) FilterWithNameAndRole(name string, role string) (result []model.CurriculumCourseYoutubeVideoEntries, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM curriculum_course_youtube_video_entries WHERE name = ? ")
	if role != "" {
