...
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Coding Minecraft', `id`, 0 FROM files WHERE `physical_file_name` = 'upcoming-schedule/codingMinecraft/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Coding Roblox', `id`, 1 FROM files WHERE `physical_file_name` = 'upcoming-schedule/codingRoblox/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Coding Python', `id`, 2 FROM files WHERE `physical_file_name` = 'upcoming-schedule/Coding_Python/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Coding Scratch', `id`, 3 FROM files WHERE `physical_file_name` = 'upcoming-schedule/Coding_Scratch/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Cyber Virtual Robotics', `id`, 4 FROM files WHERE `physical_file_name` = 'upcoming-schedule/cyberVirtualRobotics/Level 1.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Lego Robotics', `id`, 5 FROM files WHERE `physical_file_name` = 'upcoming-schedule/LEGO_Robotics/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'VEX Robotics', `id`, 6 FROM files WHERE `physical_file_name` = 'upcoming-schedule/Vex Robotics/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'AppInventor Mobile Apps', `id`, 7 FROM files WHERE `physical_file_name` = 'upcoming-schedule/AppInventor Mobile Apps/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'A.I. & Machine Learning', `id`, 8 FROM files WHERE `physical_file_name` = 'upcoming-schedule/A.I. _ Machine Learning/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT '3D Design & Printing', `id`, 9 FROM files WHERE `physical_file_name` = 'upcoming-schedule/3D_Design_Printing/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Micro:bits', `id`, 10 FROM files WHERE `physical_file_name` = 'upcoming-schedule/Micro_bit/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'AR/VR', `id`, 11 FROM files WHERE `physical_file_name` = 'upcoming-schedule/AR_VR/Level 1-min.png';
INSERT INTO curriculum_entries(`description`, `icon_id`, `seq_no_same_level`) SELECT 'Smart City', `id`, 12 FROM files WHERE `physical_file_name` = 'upcoming-schedule/Smart City/Level 1-min.png';
